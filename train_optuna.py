...
def objective(trial):
    ...
    #Override default params with search params:
    #simple parameters
    ...
    n_head = trial.suggest_int('n_head', 6, 12)
    ...
    model__mean_blocks = trial.suggest_categorical('model__mean_or_flatten', ['mean', 'flatten'])
    ...
    model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                    bias=bias, vocab_size=n_classes, dropout=dropout) # start with model_args from command line
